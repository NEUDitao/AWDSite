...
Check it out at https://cheesesisland.com/AWDSite/test/!!

That’s all I got for now. To add more posts, just make more and more files! To learn more about the theme, 
check out https://mmistakes.github.io/minimal-mistakes/docs/quick-start-guide/. To learn more about 
formatting text, check out https://guides.github.com/features/mastering-markdown/.

If you ever want to get into actual coding, and make your own website, check out the tutorials at https://www.w3schools.com/html/. And final, if you have any questions, send them to li.edwa@northeastern.edu. I’d always be happy to help!
